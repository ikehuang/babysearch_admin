...
abstract class DBModule {
    ...
    /* ========== Query Data ========== */
    protected static function _query( $query = "", $params = array(), $fetchAll = false ) {
        return self::fetch( $query, $params, $fetchAll );
    }
    protected static function _query_all( $query = "", $params = array() ) {
        return self::fetch( $query, $params, true );
    }
    protected static function _insert( $query = "", $params = array() ) {
        return self::transaction( $query, $params, true );
    }
    protected static function _update( $query = "", $params = array() ) {
        return self::transaction( $query, $params );
    }
    protected static function _delete( $query = "", $params = array() ) {
        return self::transaction( $query, $params );
    }
